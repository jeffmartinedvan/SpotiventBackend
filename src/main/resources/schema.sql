...
CREATE TABLE public.events (
	...
	CONSTRAINT fk90ap0a8qh96om4jeowoa9wniu FOREIGN KEY (city_id) REFERENCES public.city(id),
	CONSTRAINT fkat8p3s7yjcp57lny4udqvqncq FOREIGN KEY (user_id) REFERENCES public.users(id),
	CONSTRAINT fkmr4w99o4qicmmrmxnwojkxthm FOREIGN KEY (category_id) REFERENCES public.category(id)
);
